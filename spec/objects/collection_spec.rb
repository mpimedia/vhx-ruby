  ...
  describe 'api operations' do
    ...
    describe '::find' do
      it 'does not error' do
        allow(Vhx.connection).to receive(:get).and_return(OpenStruct.new(body: collection_response))
    ...
    describe '::list' do
      it 'does not error' do
        allow(Vhx.connection).to receive(:get).and_return(OpenStruct.new(body: collections_response))
    ...
    describe '::create' do
      it 'does not error' do
        allow(Vhx.connection).to receive(:post).and_return(OpenStruct.new(body: collections_response))
    ...
    describe '#udpate' do
      it 'does not error' do
        allow(Vhx.connection).to receive(:put).and_return(OpenStruct.new(body: collections_response))
